...
@JsonProperty("vip")
private Boolean vip;
@JsonProperty("available_currency")
private List<String> availableCurrency;
@JsonProperty("available_country")
private List<AvailableCountry> availableCountry;
...
@JsonProperty("available_country")
public List<AvailableCountry> getAvailableCountry() {
return availableCountry;
}

@JsonProperty("available_country")
public void setAvailableCountry(List<AvailableCountry> availableCountry) {
